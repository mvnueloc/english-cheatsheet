...
const STORAGE_KEY = "english-cheatsheet:phrasal-verb-status";
...
export default function PhrasalVerbsFlashCardPage() {
    ...
    async (mode: "reset" | "append" = "append") => {
      ...
      try {
        const response = await fetch(
          `/api/phrasal-verbs?offset=${nextOffset}&limit=${PAGE_SIZE}`,
        );
